...
function Home() {
  return (
    <div className="page home">
      <div className="tabs">
            <a className="tab" href="/portfolio/about">About Me</a>
        <a className="tab" href="/portfolio/resume">Resume</a>
        <a className="tab" href="/portfolio/projects">Projects</a>
        <a className="tab" href="/portfolio/contact">Contact Info</a>
      </div>
